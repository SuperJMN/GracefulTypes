...
namespace GracefulTypes
{
    ...
    public struct ImmutableArray<T> : IReadOnlyList<T>, IEqualityComparer<ImmutableArray<T>>, IStructuralComparable, IStructuralEquatable
    {
        ...
        {
            return new ImmutableArrayEnumerator<T>(list);
        }
        ...
        public ImmutableArray<T> Add(T value)
        {
            ...
            Array.Copy(list, 0, newArray, 0, listLength);
        ...
        public ImmutableArray<T> Insert(int index, T value)
        {
            ...
            else
            {
                ...
                Array.Copy(list, index, newArray, index + 1, listLength - index);
            }
        ...
        public static explicit operator T[] (ImmutableArray<T> list)
        {
            if (list.list != null)
            {
                return ImmutableArray.CloneArray(list.list, list.list.Length);
            }
        ...
        int IStructuralComparable.CompareTo(object other, IComparer comparer)
        {
            ...
            {
                compareArray = immutableArray.list;

                if (compareArray == null && list == null)
                {
                    return 0;
                }
            ...
            {
                return ((IStructuralComparable)compareArray).CompareTo(list, comparer);
            }
        ...
        public bool Equals(ImmutableArray<T> x, ImmutableArray<T> y)
        {
            ...
            for (var i = 0; i < x.list.Length; i++)
            {
                ...
                else if (!x.list[i].Equals(y.list[i]))
                {
                    return false;
                }
            }
        ...
        bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer)
        {
            ...
            if (compareArray != null)
            {
                return ((IStructuralEquatable)compareArray).Equals(list, comparer);
            }
        ...
        {
            IStructuralEquatable structuralEquatable = list;
        ...
        internal class ImmutableArrayEnumerator<TItter> : IEnumerator<TItter>
        {
            ...
            public TItter Current => list[count];
